...
<?php
    ...
    <input name="roll" type="text" class="none" value="<?=$_SESSION['user']['status']?>">
    ...
    <div class="comments_box"><div class="comments_login"><?=$comment['login']?></div>
    <div class="comments_status"><?=$comment['role']?></div></div>
